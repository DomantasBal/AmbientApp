export class UI {
  ...
  init() {
    ...
    this.soundCardContainer = document.querySelector('.grid');
  ...
  renderSoundCards(sounds) {
    this.soundCardContainer.innerHTML = '';
    sounds.forEach((sound) => {
      const card = this.createSoundCard(sound);
      this.soundCardContainer.appendChild(card);
    });
  }
  ...
  resetUI() {
    ...
    // reset cards
    const cards = document.querySelectorAll('.sound-cards');
    cards.forEach((card) => {
